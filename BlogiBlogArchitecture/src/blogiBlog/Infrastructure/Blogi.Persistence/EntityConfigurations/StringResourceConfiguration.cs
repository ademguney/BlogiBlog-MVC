...
,
    ...
    new StringResource { Id = 280, LanguageId = 1, Key = "blog_ui_contact_first_name", Value = "Ad" },
    new StringResource { Id = 281, LanguageId = 2, Key = "blog_ui_contact_first_name", Value = "Name" },
    new StringResource { Id = 282, LanguageId = 1, Key = "blog_ui_contact_last_name", Value = "Soyad" },
    new StringResource { Id = 283, LanguageId = 2, Key = "blog_ui_contact_last_name", Value = "Surname" },
    new StringResource { Id = 284, LanguageId = 1, Key = "blog_ui_contact_email", Value = "Email" },
    new StringResource { Id = 285, LanguageId = 2, Key = "blog_ui_contact_email", Value = "Email" },
    new StringResource { Id = 286, LanguageId = 1, Key = "blog_ui_contact_subject", Value = "Konu" },
    new StringResource { Id = 287, LanguageId = 2, Key = "blog_ui_contact_subject", Value = "Subject" }
         );
        }
    }
}
